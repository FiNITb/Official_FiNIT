...
export const AllEventData = {
  maffick: [
    ...
    <p>
        ...
        candlestick patterns 🕯️, and economic indicators 📉</b>.
    </p>
...
`,
    ...
    <ul>
        ...
        <li>⚙️ <b>Functionality</b> – Practical implementation and effectiveness</li>
    ...
    <p>
        📍 <b>The shortlisted teams were invited to <strong>MANIT Bhopal</strong></b> for an 
...
`,
    ...
    <p>
        ⚖️ <b>Following this, teams representing different ministries engaged in a structured debate:</b>
    </p>
    <ul>
        <li>📢 Presenting arguments on budget allocations</li>
        <li>❓ Counter-questioning opponents</li>
        <li>👨‍⚖️ Responding to judges’ inquiries</li>
    </ul>
